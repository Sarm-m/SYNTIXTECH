...
export default function PublicFooter() {
  return (
    <footer id="contacto" className="border-t border-slate-200 bg-slate-950 text-slate-300">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1.3fr_0.7fr_0.7fr] lg:px-8">
        <div>
          <Link to="/" className="text-xl font-black text-white">Drive<span className="text-syntix-green">Control</span></Link>
          ...
          <div className="mt-5 flex max-w-xl gap-3 rounded-xl border border-slate-800 bg-slate-900 p-4 text-xs leading-5 text-slate-400">
            <LockKeyhole className="h-5 w-5 shrink-0 text-syntix-green" />
